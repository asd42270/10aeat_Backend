...
import com.final_10aeat.global.controller.ManagerSearchArticleController;
...
public class ManagerOwnerSearchArticleControllerDocsTest extends RestDocsSupport {
    ...
    void testManageArticleSearch() throws Exception {
        // given
        List<SearchManagerManageArticleResponseDto> dto = List.of(
            SearchManagerManageArticleResponseDto.builder()
                .id(1L)
