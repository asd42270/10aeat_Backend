...
import com.final_10aeat.global.controller.OwnerSearchArticleController;
...
public class OwnerSearchArticleControllerDocsTest extends RestDocsSupport {
    ...
    public Object initController() {
        ...
        return new OwnerSearchArticleController(searchArticleUseCase);
    }
    ...
    void testManageArticleSearch() throws Exception {
        // given
        List<ManageArticleListResponseDto> dto = List.of(
