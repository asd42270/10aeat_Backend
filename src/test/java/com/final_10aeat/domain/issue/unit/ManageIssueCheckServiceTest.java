...
public class ManageIssueCheckServiceTest {
    ...
    class Context_manageIssueCheck {
        ...
        void _willSuccess() {
            ...
            given(articleIssueRepository.findFirstByManageArticleAndDeletedAtIsNullOrderByIdDesc(manageArticle))
            ...
            verify(articleIssueRepository).findFirstByManageArticleAndDeletedAtIsNullOrderByIdDesc(manageArticle);
        ...
        void _issueNotFound() {
            ...
            ArticleIssueCheckRequestDto requestDto = new ArticleIssueCheckRequestDto(true);
            given(manageArticleRepository.findById(manageArticle.getId())).willReturn(Optional.of(manageArticle));
            given(articleIssueRepository.findFirstByManageArticleAndDeletedAtIsNullOrderByIdDesc(manageArticle)).willReturn(Optional.empty());
