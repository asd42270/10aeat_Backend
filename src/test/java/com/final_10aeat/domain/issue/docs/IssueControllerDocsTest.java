...
import com.final_10aeat.domain.articleIssue.controller.IssueController;
...
public class IssueControllerDocsTest extends RestDocsSupport {
    ...
    public Object initController() {
        ...
        return new IssueController(issueService, authUserService);
    }
    ...
    void testRepairIssuePublic() throws Exception {
        //given
        CreateIssueRequestDto issueRequest = new CreateIssueRequestDto(
            "title", "content");
    ...
    void testGetManageArticleIssueHistory() throws Exception {
        ...
        given(issueService.getManageArticleIssueHistory(anyLong())).willReturn(issueHistory);
    ...
    void testGetRepairArticleIssueHistory() throws Exception {
        ...
        given(issueService.getRepairArticleIssueHistory(anyLong())).willReturn(issueHistory);
