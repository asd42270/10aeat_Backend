...
public class ManagerSearchArticleController {
    ...
    public ResponseDTO<PageDto<SearchManagerManageArticleResponseDto>> managerSearchManageArticle(
    ...
    public ResponseDTO<PageDto<SearchManagerRepairArticleResponseDto>> managerSearchRepairArticle(
        @RequestParam(required = false) String keyword,
